...
export class WelcomeComponent{
  ...
  constructor(){
    ...
    this.valuecard3 = new Valuecard('practice', 'images/values/practice.svg', 'Sharpen your new found skills. Hone them to reach your maximum potential', 'https://www.societyleadership.org/members/run-chapter/executive-board/videos');
